  ...
  return executeWithRetry(async (ai) => {
    const response = await ai.models.generateContent({
      ...
      contents: {
        parts: [
          {
            text: `Professional fashion photography, full body shot. ${description}. High fashion, photorealistic, 8k.`,
          },
        ],
      },
      config: {
      ...
      zones: {
        ...
        items: {
          ...
          properties: {
            ...
            placement: {
              type: Type.STRING,
              description: "Where in the room (e.g., Near window, North wall)",
            },
          },
        },
      },
